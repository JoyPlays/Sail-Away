...
public class FloatReference
{
	...
	/// </summary>
	[Tooltip("Float variable this object references.")] [SerializeField]
	private FloatVariable variable = null;

	/// <summary>
	/// Should a constant value be used instead of the value stored in <see cref="variable"/>?
	/// </summary>
	[Tooltip("Should a constant value be used instead of the value stored in Variable field?")] [SerializeField]
	...
	/// </summary>
	[Tooltip("Value to use if Use Constant is True.")] [SerializeField, HideIf("@this.useConstant == true")]
